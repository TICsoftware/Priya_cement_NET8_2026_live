    ...
    public class BasePageBAL : Page_Manage_DAL
    {
        ...
        protected List<ComponentModel> MapComponents(List<ComponentGroup> data, int sequence)
        {
            return Config_Application_Website.MapComponent(data, sequence, (group, dict) => new ComponentModel
            {
                ...
                Component_FileUpload1 = Config_Application_Website.GetPath(group, "component fileupload1", "Component File Upload 1"),
                Component_FileUpload2 = Config_Application_Website.GetPath(group, "component fileupload2", "Component File Upload 2"),
                FileUploadTitle1 = Config_Application_Website.GetValue(dict, "fileupload title1", "File Upload Title 1"),
                FileUploadTitle2 = Config_Application_Website.GetValue(dict, "fileupload title2", "File Upload Title 2"),
