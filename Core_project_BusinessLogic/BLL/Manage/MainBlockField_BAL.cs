...
{
    public class MainBlockField_BAL
    {
        private readonly MainBlockField_DAL dal;

        public MainBlockField_BAL(IConfiguration config)
        {
            dal = new MainBlockField_DAL(config);
        }

        public List<BlockMasterField> GetAll()
        {
            DataTable dt = dal.GetAll_DAL();
            List<BlockMasterField> list = new();

            foreach (DataRow row in dt.Rows)
            {
                list.Add(new BlockMasterField
                {
        ...
        public BlockMasterField GetById(int id)
        {
        ...
        public void Insert(BlockMasterField m) => dal.Insert_DAL(m);

        public void Update(BlockMasterField m) => dal.Update_DAL(m);
