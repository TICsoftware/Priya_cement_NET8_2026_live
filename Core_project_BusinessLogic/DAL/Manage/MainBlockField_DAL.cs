...
{
    public class MainBlockField_DAL : DBHelper
    {
        public MainBlockField_DAL(IConfiguration configuration) : base(configuration) { }

        public DataTable GetAll_DAL()
        {
            return GetDataSet("GetAllBlockFields", new SqlParameter[0]).Tables[0];
        }

        public DataTable GetById_DAL(int id)
        {
            SqlParameter[] param = { new SqlParameter("@id", id) };
            return GetDataSet("GetBlockFieldById", param).Tables[0];
        }

        public void Insert_DAL(BlockMasterField f)
        {
            SqlParameter[] param =
            {
            ...
            GetDataSet("InsertBlockField", param);
        }


        public void Update_DAL(BlockMasterField f)
        {
            SqlParameter[] param =
            {
                new("@id", f.id),
            ...
            SQLInsert_Update_Delete_Data("UpdateBlockField", param);
        }
        ...
        public void Deactivate_DAL(int id, int userId)
        {
            ...
            SQLInsert_Update_Delete_Data("DeactivateBlockField", p);
        }
    }
}
